    ...
    return (
        <>
            ...
            sattvic ingredients aligned with the body’s natural rhythms."
                image="/images/banner-4-scaled.jpg"
            />
            <section className="seyraya-wrapper">
                ...
                <div className="seyraya-images">
                    <img src="/images/l.png" alt="Seyraya healing space" />
                    <img src="/images/l.png" alt="Ayurveda therapy" />
                    <img src="/images/l.png" alt="Nature healing" />
                    <img src="/images/l.png" alt="Wellness sanctuary" />
                </div>
